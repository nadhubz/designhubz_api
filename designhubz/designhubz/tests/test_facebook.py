...
designhubz.co - development (setup /etc/hosts)
designhubz.com - production
...
2) Settings basics - set "designhubz.co" to "App Domains"
3) Add platform: Web
4) Set in "Website" -> "Site URL": http://designhubz.co/
...
8) "PRODUCTS" -> "Facebook Login" -> "Settings"
   ...
   http://designhubz.co:8080/account/login_facebook
...
class TestFacebook(base.Mixin):
    TEST_USER_EMAIL = 'set test user email'
    TEST_USER_PASSWORD = 'set test user password'
